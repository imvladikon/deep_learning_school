...
# Test Script for Task 2: Contrastive Learning (InfoNCE)
...
echo "========================================="
echo "TEST: Task 2 - Contrastive Learning"
echo "========================================="
...
echo "========================================="
echo "Test 2: Contrastive (InfoNCE)"
echo "========================================="
python "$PROJECT_ROOT/scripts/train_contrastive.py" \
    ...
    --data-root "$DATA_ROOT" \
    --exp-dir "$EXP_BASE/test_contrastive" \
    --hidden-dim 256 \
    --num-workers 2 \
    --no-wandb
...
echo "Results: $EXP_BASE/test_contrastive"
echo "========================================="
